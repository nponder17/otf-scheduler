...
export default function SystemAdminLogin() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    setError("");
    try {
      const res = await fetch(`${API_BASE}/auth/login/system-admin`, {
        method: "POST",
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        <div style={styles.title}>System Admin Login</div>
        ...
        <div style={styles.helpText}>System administrator access</div>
      </div>
    </div>
  );
}
